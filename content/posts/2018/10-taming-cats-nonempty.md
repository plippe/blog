...
As [I said previously]({{< ref "posts/2018/09-taming-cats-equality.md" >}}), Scala has a few issues, and [cats](https://typelevel.org/cats/) offer some solutions. To avoid being overwhelmed, I will only be looking at NonEmpty in this post.
