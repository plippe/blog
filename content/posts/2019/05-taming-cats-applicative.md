...
Next, Applicatives extend [Functors]({{< ref "posts/2019/04-taming-cats-functor" >}}). This gives them the `map` function, but forces them to obey the identity, and composition laws.
