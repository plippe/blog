...
Scala supports supertypes and typeclasses. Those allowed me to write a generic `maxOption` function, in a [previous article]({{ site.baseurl }}{% post_url 2019/2019-02-01-scala-generics-and-typeclasses %}). With the overview out of the way, I will show in more detail how typeclasses can add real value to your project.
