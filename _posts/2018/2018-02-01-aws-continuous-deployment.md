...
Last month, I covered how to use [AWS CodeBuild as a continuous integration solution]({{ site.baseurl }}{% post_url 2018/2018-01-01-aws-continuous-integration %}). It finished with a simple example of continuous deployment. AWS supposedly has a better solution, [AWS CodePipeline](https://aws.amazon.com/codepipeline/). Let's see if this is true.
